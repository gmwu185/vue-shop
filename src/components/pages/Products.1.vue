...
export default {
  ...
  methods: {
    getProducts(){
      ...
      // const api = `${process.env.APIPATH}/api/${process.env.CUSTOMPATH}/admin/products`; // 多的
      const vm = this;
      console.log('getProducts(): ', process.env.APIPATH, process.env.CUSTOMPATH);
    ...
    updateProduct() {
      ...
      // https://vue-course-api.hexschool.io/api/gmwu/admin/product
      let httpMethod = 'post';
      const vm = this;
      if (!vm.isNew) {
